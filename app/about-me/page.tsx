...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-950 via-slate-900 to-gray-800">
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
          {/* Photo Section */}
          <div className="relative h-64 sm:h-80 bg-gradient-to-br from-blue-600 to-purple-700">
            <div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2">
              <div className="relative w-40 h-40 sm:w-48 sm:h-48">
                {/* Replace '/your-photo.jpg' with your actual photo path */}
                <Image
                  src="/images/passportV2.jpg"
                  alt="Kevin Manan"
                  fill
                  className="rounded-full border-8 border-gray-800 shadow-2xl object-cover"
                  priority
                />
              </div>
            </div>
          ...
          {/* Bio Section */}
          <div className="pt-24 pb-12 px-6 sm:px-12">
